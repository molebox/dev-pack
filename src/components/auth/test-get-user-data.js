    ...
    typeof window !== 'undefined'
      ...
      const errorEl = error ? (
        <div className="error-box">
          Error in GetTwitterGithubProfileQuery.<br />
          {error.message && error.message.startsWith('Network') ? <span>Make sure <strong>{window.location.origin}</strong> is in your CORS origins on the OneGraph dashboard.</span> : null}
          <pre>
